    ...
    >
      ...
      <div className="site-container site-story__grid">
        <div className="site-story__visual">
          <img
            src={workerImage}
            alt={t("site.home.baristaAlt")}
          />

          <div className="site-story__stamp">
            <span
              lang={language}
              dir={direction}
            >
              {t("site.home.established")}
            </span>
        ...
        <div className="site-story__copy">
          <span
            className="site-story__eyebrow"
            lang={language}
            dir={direction}
          >
            {t("site.home.storyEyebrow")}
          </span>
          ...
          <p
            className="site-story__lead"
            lang={language}
            dir={direction}
          >
            {t("site.home.storyLead")}
          </p>
        </div>
      </div>
    </section>
